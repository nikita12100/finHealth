...
impl BalanceTimed {
    ...
    pub fn new(start_balance: u32) -> Self {
        BalanceTimed {
            id: Uuid::new_v4(),
    ...
    pub fn new_date(start_balance: u32, date: DateTime<Utc>) -> Self {
        BalanceTimed {
            id: Uuid::new_v4(),
            amount: start_balance,
            date,
    ...
    pub fn new_category(start_balance: u32, category: Option<Category>) -> Self {
        BalanceTimed {
            id: Uuid::new_v4(),
            amount: start_balance,
            date: Utc::now(),
